//Por qué cuando quiero cambiar de función tengo que tocar 2 veces el botón para que funcione?
var produ=2;
    ...
    //console.log(produ);
        ...
        switch(produ){
            ...
            case 4:
                ...
                document.getElementById('añadirProducto').style.display = "inline-block";
                //document.querySelectorAll('#tabla3 .tr2 .td1') = "" ;
                produ=3;
                //console.log(produ);
                break;
            ...
            case 3: 
                ...
                document.getElementById('añadirProducto').style.display = "inline-block";
                //let z=document.querySelectorAll('#tabla2 .tr2 .td1');
